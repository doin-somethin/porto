...
function App() {
  ...
  return (
    <div className={`relative min-h-screen w-full transition-colors duration-700 font-sans flex flex-col overflow-x-hidden ${isDarkMode ? 'text-slate-50' : 'text-slate-900'}`}>
      <GradientDots 
        dotSize={1.2}     
        spacing={6} 
        duration={24}
      ...
      <header className="relative z-50 w-full px-8 py-6 flex items-center justify-between">
        ...
        {/* LOGO */}
        <div className={`text-2xl font-bold tracking-wider transition-colors duration-300 ${isDarkMode ? 'text-white' : 'text-black'}`}>
      ...
      {/* --- MAIN CONTENT --- */}
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 md:px-8 pt-4 pb-20 -mt-10 md:-mt-0 text-center">
